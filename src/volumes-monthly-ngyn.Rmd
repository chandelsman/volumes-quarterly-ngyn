...
## `r params$year` `r params$quarter` `r lubridate::quarter(params$dt_start)`--`r lubridate::quarter(params$dt_end)`

```{r import-clean-data, echo=FALSE, message=FALSE}
# Import raw data
data_raw <- readxl::read_excel(here("data", "2020-volumes-ngyn.xls"), skip = 1)
...
data_wide_all %>%
  ...
  gt() %>%
  tab_header(
    title = md("**Volume Across All Facilities**"),
  ) %>%
  tab_options(
...
**Prepared by:** <u> &nbsp; Corey Handelsman &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</u> [**Date:** <u>`r format(as.Date(Sys.Date()), "%m/%d/%Y")` &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;]{style="float:right"}</u>
